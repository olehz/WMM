...
//     int year = 2022;
//     int prev = 2022;
//     int expdate = 1643234400; // 27-01-2022
//     int cycle = 1;

//     while (nxt < airac) // || expdate < datetime_now())
//     {
//         nxt = (expdate.tm_year - 2000) * 100 + cycle;
//         if (airac == nxt)
//         {
//             expdate.tm_mday += 14;
//             printf("%d  %d  %d", expdate.tm_year, expdate.tm_mon, expdate.tm_mday);
//             return 123;
//         }

//         expdate.tm_mday += 28;
//         year = expdate.tm_year;
//         if (year != prev)
//         {
//             prev = year;
//             cycle = 1;
